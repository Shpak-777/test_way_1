...
<header id="header" class="navbar navbar-static-top">
  ...
  <ul class="nav pull-right">
        ...
        <li class="dropdown"><a class="dropdown-toggle" href="<?php echo isset($callback) ? $callback : '' ;?>"><span class="label label-danger pull-left"><?php echo isset($countcallback) ? $countcallback : ''; ?></span> <i class="fa fa-phone-square fa-lg"></i></a><!--add-->
