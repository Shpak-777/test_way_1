...
class ControllerProductProduct extends Controller {
	...
	public function index() {
		...
		$this->load->model('catalog/category');
				...
				if (isset($xds_coloring_theme['product_short_description'])) {
					$data['short_description_off'] = $xds_coloring_theme['product_short_description'];
				}
				
				if (isset($xds_coloring_theme['product_short_attributes'])) {
					$data['short_attribute_off'] = $xds_coloring_theme['product_short_attributes'];
				}
				
				if (isset($xds_coloring_theme['product_social_likes'])) {
					$data['social_likes_off'] = $xds_coloring_theme['product_social_likes'];
				}
				...
				if (isset($xds_coloring_theme['related_product_position'])) {
					$data['related_product_position'] = $xds_coloring_theme['related_product_position'];
				}
